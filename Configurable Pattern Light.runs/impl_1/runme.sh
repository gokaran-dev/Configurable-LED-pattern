...
HD_PWD='D:/Mtech/Vivado/Configurable Pattern Light/Configurable Pattern Light.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log weddinglight_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source weddinglight_3.tcl -notrace
