...
HD_PWD='D:/Mtech/Vivado/Configurable Pattern Light/Configurable Pattern Light.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weddinglight_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weddinglight_3.tcl
